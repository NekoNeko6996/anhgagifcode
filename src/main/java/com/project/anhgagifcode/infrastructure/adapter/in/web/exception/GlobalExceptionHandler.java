...
public class GlobalExceptionHandler {
    ...
    // Bắt lỗi không tìm thấy tài nguyên -> Trả về 404 Not Found
    ...
    // Bắt lỗi vi phạm logic nghiệp vụ -> Trả về 400 Bad Request
    ...
    // Bắt tất cả các lỗi hệ thống không lường trước được -> Trả về 500 Internal Server Error
    @ExceptionHandler(Exception.class)
    public ResponseEntity<ErrorResponse> handleGlobalException(
            Exception ex, HttpServletRequest request) {
        
        log.error("Unhandled Exception at {}: ", request.getRequestURI(), ex);
        return buildErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR, "Lỗi hệ thống nội bộ, vui lòng liên hệ Admin", request.getRequestURI());
    }
