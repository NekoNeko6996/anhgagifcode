...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Yêu cầu chỉnh sửa thông tin bể quà")
public class UpdateGiftPoolRequest {
    
    @NotBlank(message = "Tên bể quà không được để trống")
    @Size(max = 150, message = "Tên bể quà không quá 150 ký tự")
    @Schema(description = "Tên bể quà mới")
    ...
    @Schema(description = "Tier mới của bể quà (A, B, C, D...)")
    private String tier;
}
